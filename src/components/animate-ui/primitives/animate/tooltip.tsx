...
type FloatingContextType = {
  ...
  setArrowRef: (element: SVGSVGElement | null) => void;
};
...
function TooltipOverlay() {
  ...
  }, [referenceElRef, setReference, update, currentTooltip]);
              ...
              >
                <Component
                  ...
                  initial={{
                    opacity: 0,
                    scale: 0,
                    ...initialFromSide(currentTooltip.side),
                  }}
                  animate={
                    tooltipOpen
...
function TooltipTrigger({
  ...
  return (
    <Component
      ...
      data-side={side}
      data-align={align}
      data-state={tooltipOpen && currentTooltip?.id === id ? 'open' : 'closed'}
      {...props}
    />
  );
}
