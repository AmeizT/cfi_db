...
test("report entry actions use canonical wizard routes with current context", () => {
    ...
    const expected = {
        attendance: "/record-center?workspace=monthly-report&section=attendance&method=manual-entry&report_id=84",
        tithe: "/record-center?workspace=monthly-report&section=tithes&method=manual-entry&report_id=84",
        revenue: "/record-center?workspace=monthly-report&section=revenue&method=manual-entry&report_id=84",
        "operating-expense": "/record-center?workspace=monthly-report&section=overhead&method=manual-entry&report_id=84",
        "activity-expense": "/record-center?workspace=monthly-report&section=expenses&method=manual-entry&report_id=84",
    }
...
test("reopened reports preserve amendment context", () => {
    assert.equal(
        ...
        "/record-center?workspace=monthly-report&section=revenue&method=manual-entry&report_id=84&amendment_context=reopened",
    )
})
