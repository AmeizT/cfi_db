...
// import { PlaceholderReport } from "../core/types/placeholder-report"
...
//     const { data: reports = [], isLoading, isError } = useReports({ year: period })
//     const yearValue = typeof period === "string" ? parseInt(period, 10) : currentYear
...
//         const selectedYear = period || currentYear.toString()
...
//         return matchesStatus && matchesYear && matchesAssembly && matchesSearch
//     })
...
//                     <ReportFilters statusQuery={status} yearQuery={period} monthQuery={month} />
