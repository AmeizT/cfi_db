    ...
    return (
        <div className="bg-white dark:bg-slate-800 rounded-2xl border-0 border-slate-200 dark:border-slate-700">
            ...
            <div className="relative">
                <div className="absolute top-8 left-0 right-0 h-px bg-slate-200 dark:bg-slate-700 rounded-full"></div>
                        ...
                        <div className="space-y-2">
                            {selectedReport.sections.map(section => (
                                <div key={section.id} className="flex items-center gap-3 p-3 bg-slate-50 dark:bg-slate-700 rounded-lg">
                                    {section.submitted ? (
                                        <IconCircleCheckFilled className="size-5 text-theme-500" />
                                    ) : (
                                        <IconCircle className="size-5 text-slate-400" />
                                    )}
                                    <span className={cn(
                                        'font-medium',
                                        section.submitted ? 'text-theme-500 line-through' : 'text-slate-700 dark:text-slate-300'
                                    )}>
                                        {section.title}
                                    </span>
                                </div>
