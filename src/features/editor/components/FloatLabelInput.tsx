    ...
    return (
        <FormField {...rest} tip={tip} isRequired={isRequired}>
            <div className="relative w-full">
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Button
                                    ...
                                    className="absolute right-1.5 top-1/2 -translate-y-1/2 border-0 bg-transparent px-2 text-zinc-700 shadow-none hover:bg-inherit hover:text-zinc-800 dark:text-white dark:hover:text-white"
                                >
                                    {isPasswordVisible ? (
                ...
                <label
                    htmlFor={inputId}
                    className="absolute text-[15px] text-zinc-500 font-medium dark:text-body-muted duration-250 transform -translate-y-2.5 scale-80 top-4 z-10 origin-left start-4 peer-focus:font-normal peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-80 peer-focus:-translate-y-2.5 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto cursor-text"
                >
                    {label}
                    {error && (
