    ...
    return (
        <section className="w-1/2 hidden lg:flex justify-center items-center">
            <div className="px-0 relative w-full h-full hidden lg:flex flex-col justify-center gap-6">
                ...
                {/* <div className="absolute h-full w-full flex items-center bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] dark:bg-[radial-gradient(#ffffff60,transparent_1px)] [background-size:16px_16px] [mask-image:radial-gradient(ellipse_50%_50%_at_50%_50%,#000_70%,transparent_100%)] z-50">
