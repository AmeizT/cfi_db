...
export function MonthlyReportFooter({
  ...
  return (
    <footer className="sticky bottom-3 z-20 mx-3 mt-6 rounded-2xl border border-border-subtle bg-background/92 px-3 py-3 shadow-elevation-01 backdrop-blur supports-[backdrop-filter]:bg-background/82 sm:mx-5 sm:px-4 lg:mx-0">
