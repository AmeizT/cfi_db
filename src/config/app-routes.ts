export const APP_ROUTES = {
    ...
    members: {
        ...
        onboarding: "/members/lifecycle/onboarding",
        baptisms: "/members/lifecycle/baptisms",
        dedications: "/members/lifecycle/dedications",
        transfers: "/members/lifecycle/transfers",
    },
    spaces: "/spaces",
    assets: "/assets",
    library: "/library",
